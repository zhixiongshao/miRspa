...
def load_model(checkpoint_path: str, device: torch.device):
    ...
    # containing numpy scalar objects in the config. This project loads checkpoints
    # that we trust (e.g. our Zenodo release), so we explicitly set weights_only=False.
    try:
