...
def render_hairpin_svg(
    *,
    ...
    parts.append(
        ...
        ".bp{stroke:rgba(15,23,42,0.35);stroke-width:1.2;}"
        ".bb{fill:rgba(255,255,255,0.92);stroke:rgba(148,163,184,0.65);stroke-width:1;}"
        ".btxt{font-size:11px;font-weight:800;fill:#0f172a;text-anchor:middle;dominant-baseline:middle;}"
        "</style></defs>"
    )
    ...
    for k in range(n):
        ...
        parts.append(f'<circle class="bb" cx="{x:.2f}" cy="{y:.2f}" r="{r}"/>')
